                    ...
                    <div class="card-body">
                        ...
                        if (isset($_POST['kirim'])) {
                            ...
                            { 
                                ...
                                //ubah status orderan
                                $qupdate = "UPDATE tbl_order SET status='Menunggu Konfirmasi Pembayaran' WHERE id_order='$id'";
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama" onkeyup="isi_otomatis()"  required="required">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="jml_transfer"  value="<?php echo ($data['total_order']); ?>" readonly>
                            </div>
                            <div class="form-group">
