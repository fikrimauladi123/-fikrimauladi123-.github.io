    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="sub mb-3">
                    Penulis : <span class="text-primary">Admin Sugihmukti</span> | <i class="fa fa-calendar"></i> <?php echo date("F d, Y", strtotime($tgl)); ?>
                </div>
                ...
                <!-- <div class="row">
                    <div class="col">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center" style="background-color: transparent;">Biji Bijian
