    ...
    <div class="row text-center mb-5">
        ...
        ?>
            <div class="col-md-4 col-sm-12 ">
                <div class="imgup mb-2"><img src="admin/assets/images/foto_pos/<?php echo $data['gambar']; ?>" height="280px" width="100%" alt="...">
                </div>
                <h5><a href="detail-blog.php?id=<?php echo $data['id_pos'] ?>" class="font-weight-bold"><?php echo $data['judul']; ?></a></h5>
                <hr align="center">
    ...
    <div class="row text-left mb-5">
        ...
        ?>
            <div class="col-md-8 col-sm-12">
                ...
                <hr align="left">
                <div class="imgup mb-2"> <img src="admin/assets/images/foto_pos/<?php echo $data['gambar']; ?>" height="400pxpx" width="100%" alt="..."></div>
                <h5>
        ...
        <div class="col-md-4 col-sm-12">
            ...
            <div class="row">
                <div class="col">
                    <h5>KATEGORI SEDANG PANEN</h5>
                    <hr align="left">
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center" style="background-color: transparent;">SAYURAN
                            <span class="badge badge-success badge-pill">10</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center" style="background-color: transparent;">UMBI UMBIAN
                            <span class="badge badge-success badge-pill">25</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center" style="background-color: transparent;">KACANG KACANGAN
                            <span class="badge badge-success badge-pill">32</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center" style="background-color: transparent;">TANAMAN HERBAL
        ...
        <div class="row mb-3">
            ...
            ?>
                <div class="col-md-4 col-sm-12 mb-4">
                    <div class="imgup mb-2"><img src="admin/assets/images/foto_pos/<?php echo $data['gambar']; ?>" height="280px" width="100%" alt="..."></div>
                    <h5>
                        <a href="detail-blog.php?id=<?php echo $data['id_pos'] ?>" class="font-weight-bold "><?php echo $hasil2 . ' . . .'; ?></a>
                    </h5>
