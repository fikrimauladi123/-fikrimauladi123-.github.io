...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="assets/img/icon/tani.png">
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white m-0 p-0">
            <div class="container pl-3 pr-3">
                <a class=" navbar-brand" href="#">
                    <img src="assets/img/icon/logokelompoktani.jpg" width="80" height="80" alt="">
                </a>
                ...
                <div class="collapse navbar-collapse  justify-content-center" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="cart.php"><i class="fa fa-shopping-basket text-secondary" style="font-size: 17px;"></i></a>
                        </li>
                    </ul>
                </div>
                <?php if (isset($_SESSION["pelanggan"])) : ?>
                    <button class="btn btn-secondary navbar-btn m-2" onclick="window.location.href='logout.php'">Logout</button>
                <?php else : ?>
                    <button class="btn btn-secondary navbar-btn m-2" onclick="window.location.href='login.php'">Login</button>
                <?php endif ?>
