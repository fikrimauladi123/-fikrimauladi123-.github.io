...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/icon/logokelompoktani.jpg">
    ...
    <style>
        body {
            ...
            background: url(assets/img/tani1.jpeg) no-repeat center center fixed;
...
<body>
    <div class="signup-form">
        <form action="" method="post">
            <h2>Log In</h2>
            <p><img src="assets/img/logologin.png" width="100" height="100" ></p>
            <p>SUGIH MUKTI</p>
            <p>Silahkan Login!</p>
            <hr>
            ...
            <button class="btn btn-primary btn-lg" name="login" id="submit">Masuk</button>
            ...
            <div class="form-group text-right down">
                <label class="forget"> Belum punya akun? <a href="signup.php">daftar</a></label>
            </div>
        </form>
        <?php
